...
import org.cresplanex.nova.stomp.dto.ErrorAttributeDto;
import org.cresplanex.nova.stomp.dto.ErrorResponseDto;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        ErrorResponseDto errorResponseDTO = ErrorResponseDto.create(
                ServerErrorCode.STOMP_VALIDATION_ERROR,
                "Validation Error",
                errorAttributeDTO
        );
    ...
    public ResponseEntity<Object> handleHttpRequestMethodNotSupported(
        ...
        ErrorResponseDto errorResponseDTO = ErrorResponseDto.create(
                ServerErrorCode.STOMP_METHOD_NOT_ALLOWED,
    ...
    public ResponseEntity<Object> handleHttpMediaTypeNotSupported(
        ...
        ErrorResponseDto errorResponseDTO = ErrorResponseDto.create(
                ServerErrorCode.STOMP_NOT_SUPPORT_CONTENT_TYPE,
    ...
    public ResponseEntity<Object> handleMissingPathVariable(
        ...
        ErrorResponseDto errorResponseDTO = ErrorResponseDto.create(
                ServerErrorCode.STOMP_MISSING_PATH_VARIABLE,
                "Validation Error",
                errorAttributeDTO
        );
    ...
    public ResponseEntity<Object> handleMaxUploadSizeExceededException(
        ...
        ErrorResponseDto errorResponseDTO = ErrorResponseDto.create(
                ServerErrorCode.STOMP_EXCEED_MAX_UPLOAD_SIZE,
                "Validation Error",
                errorAttributeDTO
        );
    ...
    public ResponseEntity<Object> handleNoResourceFoundException(
        ...
        ErrorResponseDto errorResponseDTO = ErrorResponseDto.create(
                ServerErrorCode.STOMP_NOT_FOUND_HANDLER,
                "Not Found",
                errorAttributeDTO
        );
    ...
    public ResponseEntity<Object> handleHttpMessageNotReadable(
        ...
        ErrorResponseDto errorResponseDTO = ErrorResponseDto.create(
                ServerErrorCode.STOMP_NOT_READABLE_REQUEST,
    ...
    public ResponseEntity<Object> handleAuthenticationException(
        ...
        ErrorResponseDto errorResponseDTO = ErrorResponseDto.create(
                ServerErrorCode.STOMP_AUTHENTICATION_FAILED,
    ...
    public ResponseEntity<Object> handleAccessDeniedException(
        ...
        ErrorResponseDto errorResponseDTO = ErrorResponseDto.create(
                ServerErrorCode.STOMP_ACCESS_DENIED,
                "Access Denied",
                errorAttributeDTO
        );
    ...
    public ResponseEntity<Object> handleMethodArgumentTypeMismatch(
        ...
        ErrorResponseDto errorResponseDTO = ErrorResponseDto.create(
                ServerErrorCode.STOMP_METHOD_ARGUMENT_TYPE_MISMATCH,
                "Validation Error",
                errorAttributeDTO
        );
    ...
    public ResponseEntity<Object> handleGlobalException(
        ...
        ErrorResponseDto errorResponseDTO = ErrorResponseDto.create(
                ServerErrorCode.STOMP_INTERNAL_ERROR,
                "Internal Server Error",
                errorAttributeDTO
        );
